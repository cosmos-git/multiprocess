...
/*
 * TODO: Some of the logic in this file is patterned from vhost-user. These
 * functions are good candidates for refactoring, especially
 * get_fd_from_hostaddr(), proxy_mrs_can_merge() and
